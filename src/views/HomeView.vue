...
/**
 * Validate reason for joining - shows positive message if contains 'friend'
 */
      ...
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm">
          ...
          <div class="mb-3">
            ...
            <div v-if="formData.reason && formData.reason.toLowerCase().includes('friend')" class="text-success">
